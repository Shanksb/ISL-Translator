A real-time hand sign recognition system built as an academic project, using **MediaPipe** for hand joint detection and **MobileNetV2 (TensorFlow)** for machine learning–based classification. 
